            ...
            <div class="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0" style="background-color: yellow-500;">
                ...
                <div class="w-full py-6 z-20">
                    ...
                    <form action="{{ route('new.contact') }}" method="GET" class="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                        <div class="pb-2 pt-4">
                            <input type="email" name="email" id="email" placeholder="Email" class="block w-full p-4 text-lg rounded-xl bg-white">
                        </div>
                        <div class="pb-2 pt-4">
                            <input class="block w-full p-4 text-lg rounded-xl bg-white" type="password" name="password" id="password" placeholder="Password">
                        </div>
                        <div class="text-right text-white hover:underline">
                            <a href="#">Forgot your password?</a>
                        </div>
                        <div class="px-4 pb-2 pt-4">
                            <button class="uppercase block w-full p-4 text-lg rounded-full bg-green-700 hover:bg-lime-500 focus:outline-none">sign in</button>
                        </div>
                        ...
                        <div class="text-white">
                            ...
                            <a href="{{ route('new.register') }} " class="hover:underline">Daftar di sini</a>
                        </div>
                    </form>
                </div>
            </div>
