<footer class="bg-white dark:bg-gray-900">
    <div class="container px-6 py-8 mx-auto">
        <div class="flex flex-col items-center text-center">
            <div class="flex items-center justify-center ml-16 lg:pr-16 pr-6">
                <h2 class="font-normal text-2xl leading-6 text-gray-800">C</h2>
                ...
                <h2 class="font-normal text-2xl leading-6 text-gray-800">ntact</h2>
            </div>

            <p class="max-w-md mx-auto mt-4 text-gray-500 dark:text-gray-400">Simpan kontak anda dengan aman</p>

            <div class="flex flex-col mt-4 sm:flex-row sm:items-center sm:justify-center">

                <button class="w-full px-5 py-2 text-sm tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-600 rounded-md sm:mx-2 sm:order-2 sm:w-auto hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80">Mulai Simpan</button>
            </div>
        </div>
